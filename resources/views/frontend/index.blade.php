            ...
            <div class="ed-mob-menu-con">
                ...
                <div class="ed-mm-right">
                    <div class="ed-mm-menu">
                        ...
                        <div class="ed-mm-inn">
                            <a href="{{url('/all-courses')}}" class="ed-mi-close"><i class="fa fa-times"></i></a>
                            <h4>All Courses</h4>
                            <ul>
            ...
            <div class="carousel-inner">
                <div class="item slider1 active">
                    ...
                    <div class="carousel-caption slider-con">
                        ...
                        <a href="{{url('/all-courses')}}" class="bann-btn-1">All Courses</a><a href="{{url('/about-us')}}" class="bann-btn-2">Read More</a>
                    </div>
                </div>
                <div class="item">
                    ...
                    <div class="carousel-caption slider-con">
                        ...
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form</p>
                        <a href="{{url('/admission')}}" class="bann-btn-1">Admission</a><a href="{{url('/about-us')}}" class="bann-btn-2">Read More</a>
                    </div>
                </div>
                <div class="item">
        ...
        <div class="container">
            <div class="row">
                <div class="wed-hom-ser">
                    <ul>
                        <li>
                            <a href="{{url('/awards')}}" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img src="{{asset('frontend/images/icon/h-ic1.png')}}" alt=""> Academy</a>
                        </li>
                        <li>
                            <a href="{{url('admission')}}" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img src="{{asset('frontend/images/icon/h-ic2.png')}}" alt=""> Admission</a>
                        </li>
                        <li>
                            <a href="{{url('/all-courses')}}" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img src="{{asset('frontend/images/icon/h-ic4.png')}}" alt=""> Courses</a>
                        </li>
                        <li>
                            <a href="{{url('/seminar')}}" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img src="{{asset('frontend/images/icon/h-ic3.png')}}" alt=""> Seminar</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="ed-course">
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="{{url('/about-us')}}">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="{{url('/students')}}">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="{{url('/research')}}">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="{{url('/all-courses')}}">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="{{url('/db-time-line')}}">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="{{url('/events')}}">
