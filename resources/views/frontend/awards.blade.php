                        ...
                        <ul>
                            <li>
                                <div class="age-eve-com age-eve-1">
                                    <img src="{{asset('frontend/images/icon/awa/1.png')}}" alt="">
                                </div>
                            ...
                            <li>
                                <div class="age-eve-com age-eve-1">
                                    <img src="{{asset('frontend/images/icon/awa/2.png')}}" alt="">
                                </div>
                                <div class="s17-eve-time">
                                    <div class="s17-eve-time-tim">
                            ...
                            <li>
                                <div class="age-eve-com age-eve-1">
                                    <img src="{{asset('frontend/images/icon/awa/3.png')}}" alt="">
                                </div>
                                <div class="s17-eve-time">
                                    <div class="s17-eve-time-tim">
                                        <span>09:00AM - 10:30AM</span>
                            ...
                            <li>
                                <div class="age-eve-com age-eve-1">
                                    <img src="{{asset('frontend/images/icon/awa/4.png')}}" alt="">
                                </div>
                                <div class="s17-eve-time">
                                    <div class="s17-eve-time-tim">
                            ...
                            <li>
                                <div class="age-eve-com age-eve-1">
                                    <img src="{{asset('frontend/images/icon/awa/5.png')}}" alt="">
                                </div>
                                <div class="s17-eve-time">
                                    <div class="s17-eve-time-tim">
                            ...
                            <li>
                                <div class="age-eve-com age-eve-1">
                                    <img src="{{asset('frontend/images/icon/awa/6.png')}}" alt="">
                                </div>
                                <div class="s17-eve-time">
                                    <div class="s17-eve-time-tim">
                            ...
                            <li>
                                <div class="age-eve-com age-eve-1">
                                    <img src="{{asset('frontend/images/icon/awa/7.png')}}" alt="">
                                </div>
                                <div class="s17-eve-time">
                                    <div class="s17-eve-time-tim">
                                        <span>10:30AM - 10:45AM</span>
                            ...
                            <li>
                                <div class="age-eve-com age-eve-1">
                                    <img src="{{asset('frontend/images/icon/awa/8.png')}}" alt="">
                                </div>
                                <div class="s17-eve-time">
                                    <div class="s17-eve-time-tim">
                                        <span>10:30AM - 10:45AM</span>
                            ...
                            <li>
                                <div class="age-eve-com age-eve-1">
                                    <img src="{{asset('frontend/images/icon/awa/9.png')}}" alt="">
                                </div>
                                <div class="s17-eve-time">
                                    <div class="s17-eve-time-tim">
                                        <span>10:30AM - 10:45AM</span>
                            ...
                            <li>
                                <div class="age-eve-com age-eve-1">
                                    <img src="{{asset('frontend/images/icon/awa/10.png')}}" alt="">
                                </div>
                                <div class="s17-eve-time">
                                    <div class="s17-eve-time-tim">
                                        <span>10:30AM - 10:45AM</span>
                            ...
                            <li>
                                <div class="age-eve-com age-eve-1">
                                    <img src="{{asset('frontend/images/icon/awa/11.png')}}" alt="">
                                </div>
                                <div class="s17-eve-time">
                                    <div class="s17-eve-time-tim">
                                        <span>10:30AM - 10:45AM</span>
                            ...
                            <li>
                                <div class="age-eve-com age-eve-1">
                                    <img src="{{asset('frontend/images/icon/awa/12.png')}}" alt="">
                                </div>
