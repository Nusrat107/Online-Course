                    ...
                    <div class="card">
                        <div class="body">
                            <div class="chat-widget">
                                <ul class="list-unstyled">
                                    <li class="left">
                                        <img src="{{asset('backend/assets/images/xs/avatar3.jpg')}}" class="rounded-circle" alt="">
                                    ...
                                    <li class="left">
                                        <img src="{{asset('backend/assets/images/xs/avatar5.jpg')}}" class="rounded-circle" alt="">
                                        <ul class="list-unstyled chat_info">
