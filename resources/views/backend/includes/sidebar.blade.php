                        ...
                        <li>
                            <div class="progress-container">
                                ...
                                <ul class="list-unstyled team-info">
                                    <li class="m-r-15"><small>Team</small></li>
                                    <li>
                                        <img src="{{asset('backend/assets/images/xs/avatar10.jp')}}g" alt="Avatar">
                                    </li>
                                    <li>
...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    <a class="image" href="profile.html"><img src="{{asset('backend/assets/images/profile_av.jpg')}}" alt="User"></a>
                    <div class="detail">
                        <h4>Michael</h4>
            ...
            <li class="active open"><a href="{{url('/admin/dashboard')}}"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-folder"></i><span>Event</span></a>
                <ul class="ml-menu">
                    <li><a href="#">Event</a></li>
                    <li><a href="#">Event Register</a></li>
                    <li><a href="#">Event Read</a></li>
                   
                </ul>
            </li>

             <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-swap-alt"></i><span>Students</span></a>
                <ul class="ml-menu">
                    <li><a href="ui_kit.html">Profile</a></li>                    
                    <li><a href="alerts.html">User Profile</a></li>                    
                    <li><a href="collapse.html">Course</a></li>
                    <li><a href="colors.html">Exam</a></li>
                    <li><a href="dialogs.html">Timeline</a></li>                    
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-flower"></i><span>Contact Us</span></a>
                <ul class="ml-menu">
                    <li><a href="icons.html">Message</a></li>
                    <li><a href="icons-themify.html">Register</a></li>
